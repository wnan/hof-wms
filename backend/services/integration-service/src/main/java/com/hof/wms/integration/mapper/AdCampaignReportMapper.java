...
public interface AdCampaignReportMapper extends BaseMapper<AdCampaignReport> {
    ...
    @Insert("INSERT INTO sf_api.ad_campaign_report " +
            "(shop_id, shop_name, report_date, campaign_name, targeting_type, campaign_status, " +
            ...
            "VALUES (#{shopId}, #{shopName}, #{reportDate}, #{campaignName}, #{targetingType}, #{campaignStatus}, " +
            ...
            "ON CONFLICT (shop_id, campaign_name, report_date) DO UPDATE SET " +
